...
//    }
    ...
    private static MessageDigest getDigest(String algoritmo)  throws Exception {
    ...
    private static MessageDigest addSalt(MessageDigest digest, String salt) throws Exception {
        digest.update(salt.getBytes(CHARSET));
        return digest;
    }

    private static byte[] digest(MessageDigest digest, String str) throws Exception {
        return digest.digest(str.getBytes(CHARSET));
    }

    private static byte[] digestWithSalt(MessageDigest digest, String str, String salt) throws Exception {
