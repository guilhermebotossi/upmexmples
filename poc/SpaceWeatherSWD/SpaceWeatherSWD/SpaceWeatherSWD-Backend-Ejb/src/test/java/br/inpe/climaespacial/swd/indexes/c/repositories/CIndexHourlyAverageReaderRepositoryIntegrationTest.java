...
@AdditionalClasses({
    ...
    DefaultCIndexHourlyAverageReaderRepository.class,
    DefaultHourlyAverageFactory.class,
    DefaultHourlyAverageMapper.class,
    EntityManagerFactoryProducer.class,
    EntityManagerProducer.class
})
public class CIndexHourlyAverageReaderRepositoryIntegrationTest extends BaseIntegrationTest {
    ...
    public void getHourlyAverage_called_returnsHourlyAverageFromLastCalculatedCIndex() {
        when(cIndexReaderRepository.getNextHourToBeCalculated()).thenReturn(zonedDateTime);
        HourlyAverageEntity hae = create();
        entityManager.persist(hae);

        HourlyAverage ha = cIndexHourlyAverageReaderRepository.getHourlyAverage();
